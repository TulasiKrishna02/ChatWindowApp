...
const SignupForm = ({ onSignupSuccess }) => {
  ...
  // Handle the "Clear" button click (reset all form fields)
  const handleClear = () => {
    setUsername("");
    setName("");
    setEmail("");
    ...
    <div className="flex items-center justify-center h-screen">
      ...
      >
        ...
        <div className="flex items-center justify-between space-x-2">
          ...
          <button
            type="button"
            onClick={handleClear} // Call handleClear when the button is clicked
            className="w-full bg-gray-300 text-black py-2 px-4 rounded focus:outline-none focus:bg-gray-400"
          >
            Clear
          </button>
        </div>
