...
public class ChatController {
	...
	public Message receiveMessage(Message message) throws InterruptedException {
		...
		chatMessageRepository
				.save(new ChatMessage(message.getSenderName(), message.getReceiverName(), message.getMessage(),
						message.getMedia(), message.getMediaType(), message.getStatus(), System.currentTimeMillis() // Current
																													// timestamp
				));
